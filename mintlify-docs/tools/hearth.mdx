...
description: "Reach your SoulForge from Telegram, Discord, or iMessage."
icon: "mobile"
---
...
<Steps>
  ...
  <Step title="Create a bot and store the token">
    Create a bot on [@BotFather](https://t.me/BotFather) (Telegram), [Discord Developer Portal](https://discord.com/developers/applications), or skip this for iMessage.
...
| **iMessage** | macOS only | Handle (`+15551234567` or email) — requires Full Disk Access |
...
- **No iMessage on Linux.** No safe path exists.
